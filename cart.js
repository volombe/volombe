...
async function showCheckout() {
  ...
  /* URL de l'API — fonctionne en local (next dev) et en production */
  ...
  try {
    ...
    errMsg.textContent = '⚠ Serveur inaccessible — lancez "npm run dev" et ouvrez http://localhost:3000';
    errMsg.style.cssText = 'margin-top:10px;font-size:.7rem;color:var(--gold);text-align:center;padding:8px;';
